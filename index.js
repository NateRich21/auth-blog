...
//Setup SQlite Database and create endpoints with epilogue

// sets up connections with SQlite
const database = new Sequelize({
    dialect: 'sqlite',
    storage: './db.sqlite'
  });

//defines the model that represents my database
const Post = database.define('posts', {   //
    title: Sequelize.STRING,
    content: Sequelize.TEXT,
});

//initilizes Epilogue with my express.js app and the database above
epilogue.initialize({ app, sequelize: database });

//creates the REST resource
...
//authentication check on CRUD routes to protect endpoints
